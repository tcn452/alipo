...
const CHICHEWA: Record<string, string> = {
  ...
  'All reports': 'Malipoti onse', 'All': 'Onse', 'All fuel': 'Mafuta onse', 'Fuel type filter': 'Sankhani mtundu wa mafuta', 'Fuel availability': 'Kupezeka kwa mafuta', 'Radius': 'Utali', 'Search radius': 'Utali wosakira', 'Search area': 'Malo osakira', 'Show station list': 'Onetsani mndandanda wa malo', 'Show map': 'Onetsani mapu',
