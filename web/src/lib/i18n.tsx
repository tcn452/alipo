...
const CHICHEWA: Record<string, string> = {
  'Find fuel': 'Pezani mafuta',
  'Search': 'Sakani',
  'Clear search': 'Chotsani zosaka',
  'Choose area': 'Sankhani dera',
  'Area': 'Dera',
  'Has fuel': 'Mafuta alipo',
  'More filters': 'Zosefera zina',
  'All statuses': 'Mikhalidwe yonse',
  'Any report age': 'Malipoti a nthawi iliyonse',
  'Recent reports': 'Malipoti atsopano',
  'Older reports': 'Malipoti akale',
  'Report age': 'Nthawi ya lipoti',
  'Available or low supply, reported in the last 4 hours.': 'Mafuta alipo kapena atsala pang’ono, malinga ndi malipoti a maola 4 apitawa.',
  'Recent reports are less than 4 hours old. Older reports may no longer be accurate.': 'Malipoti atsopano ndi a pasanathe maola 4. Akale angakhale osalondola tsopano.',
  'Remove filter: {filter}': 'Chotsani chosefera: {filter}',
  'Clear filters': 'Chotsani zosefera',
  'Choose an area or enable location to find nearby stations.': 'Sankhani dera kapena lolani malo anu kuti mupeze masiteshoni apafupi.',
  'Distance from your current location.': 'Utali kuchokera pomwe muli.',
  'Distance from the city centre.': 'Utali kuchokera pakati pa mzinda.',
  'Show stations': 'Onetsani masiteshoni',
  'Reset': 'Bwezeretsani',
  'Searching across Malawi.': 'Tikusaka ku Malawi konse.',
  'Searching within {radius} km of {area}.': 'Tikusaka mkati mwa {radius} km kuchokera ku {area}.',
  'your location': 'malo anu',
  'No recent petrol availability reports match.': 'Palibe malipoti atsopano a petulo omwe akugwirizana ndi zosaka zanu.',
  'No recent diesel availability reports match.': 'Palibe malipoti atsopano a dizilo omwe akugwirizana ndi zosaka zanu.',
  'No recent fuel availability reports match.': 'Palibe malipoti atsopano a mafuta omwe akugwirizana ndi zosaka zanu.',
  'Missing reports do not mean there is no fuel.': 'Kusowa kwa malipoti sikutanthauza kuti mafuta palibe.',
  'Expand to {radius} km': 'Onjezerani kufika {radius} km',
  'Show all statuses': 'Onetsani mikhalidwe yonse',
  'Get a reminder to share an update when you reach a station.': 'Landirani chikumbutso choti mupereke lipoti mukafika pa siteshoni.',
  'Enable alerts': 'Yatsani zidziwitso',
  ...
  "Looks like you're here": 'Zikuoneka kuti muli pano',
  'Hey — {station} is about {metres} m away': 'Moni — {station} ili pafupi ndi mamita {metres}',
  "If you're parked, share what you see so the next driver isn't guessing.": 'Ngati mwaimitsa, gawanani zomwe mukuona kuti woyendetsa wotsatira asaganizire chabe.',
  'Share what I see': 'Gawanani zomwe ndikuona',
  'Station alerts': 'Zidziwitso za siteshoni', 'Alerts on': 'Zidziwitso zatsegulidwa', 'Are you at {station}?': 'Kodi muli pa {station}?',
  'Hey — looks like you stopped at {station}': 'Moni — zikuoneka kuti mwaima pa {station}',
  "You're about {metres} m from {place}. If you're parked safely, tap to share whether petrol or diesel is available — it helps the next driver.": 'Muli pafupi ndi mamita {metres} kuchokera ku {place}. Ngati mwaimitsa bwino, dinani kuti mugawane ngati petulo kapena dizilo ilipo — zimathandiza woyendetsa wotsatira.',
  "I'm here — report": 'Ndili pano — tiuzeni',
  'Not me': 'Si ine',
