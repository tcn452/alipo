...
import { ArrowRight, Check, CheckCircle2, CircleAlert, Globe, LocateFixed, MapPin, Sparkles, XCircle } from 'lucide-react';
...
export function OnboardingModal({ isOpen, onClose, onAllowLocation, isLocationActive }: OnboardingModalProps) {
          ...
          {step === 3 && (
            <div className="space-y-5">
              ...
              <div className="space-y-2.5 pt-1 text-xs">
                ...
                <div className="border border-dashed border-forest/30 bg-[#eff5eb] p-3">
                  <strong className="block text-forest">{t('Help other drivers')}</strong>
                  <p className="mt-0.5 text-[11px] text-muted">
                    {t('Tap "Update" whenever you see fuel to keep Malawi moving.')}
                  </p>
                </div>
              </div>
